...
SWEP.PrintName = "Sabre Laser de Guerrier Sith"
...
SWEP.ForcePowers = {
{
 ...
 {
		name = "Canaliser sa haine",
		icon = "C",
		description = "Enragez-vous et recharger votre force et votre santé.",
		think = function( self )
...
local function DrawHUDBox( x, y, w, h, b )
	...
	if ( b ) then
		...
		surface.SetDrawColor( Color( 255, 0, 0, 4 ) )
		surface.DrawTexturedRect( x, y, w, h )
	end
...
function SWEP:DrawHUD()
	...
	draw.RoundedBox( 0, x, y, barW, h, Color( 255, 0, 0, 255 ) )
	...
	for id, t in pairs( self.ForcePowers ) do
		...
		if ( self:GetForceType() == id ) then
			...
			draw.RoundedBox( 0, x, y, h, bar, Color( 255, 0, 0, 255 ) )
		end
	end
