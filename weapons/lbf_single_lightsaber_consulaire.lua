...
SWEP.PrintName = "Sabre Laser de Consulaire Jedi"
SWEP.Author = "Robotboy655 edit by Watcher"
SWEP.Category = "Watcher's Weapons"
SWEP.Contact = ""
SWEP.Purpose = ""
SWEP.Instructions = "Manches et selectionnables."
...

{
		...
		distance = 600,
		target = 1,
		description = "Une concentration de force Lumineuse qui frappe votre adversaire !",
		action = function( self )
			...
			ed:SetEntity( ent )
			util.Effect( "rb655_force_blank", ed, true, true )
...
function SWEP:Deploy()
	...
	self:SetMaxLength( 42 )
	self:SetCrystalColor( Vector( 33 , 255 , 0 ) )
